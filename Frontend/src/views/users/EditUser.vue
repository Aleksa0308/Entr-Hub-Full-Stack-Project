...
export default {
    ...
    mounted() {
        ...
        this.form.username = this.singleItem.username
        this.form.email = this.singleItem.email
        this.form.role = this.singleItem.role
    },
    methods: {
        ...mapActions([
            'fetchUser',
        ...
        onSubmit(e) {
            e.preventDefault();
            this.id = this.$route.params.id;
            this.updateUsers({obj: this.form, id: this.id});
